...
enum Instruction {
  ...
  // Memory
  I32Load(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load(offset: Int, align: Int, ?memoryIndex: Int);
  F32Load(offset: Int, align: Int, ?memoryIndex: Int);
  F64Load(offset: Int, align: Int, ?memoryIndex: Int);
  I32Load8S(offset: Int, align: Int, ?memoryIndex: Int);
  I32Load8U(offset: Int, align: Int, ?memoryIndex: Int);
  I32Load16S(offset: Int, align: Int, ?memoryIndex: Int);
  I32Load16U(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load8S(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load8U(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load16S(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load16U(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load32S(offset: Int, align: Int, ?memoryIndex: Int);
  I64Load32U(offset: Int, align: Int, ?memoryIndex: Int);
  I32Store(offset: Int, align: Int, ?memoryIndex: Int);
  I64Store(offset: Int, align: Int, ?memoryIndex: Int);
  F32Store(offset: Int, align: Int, ?memoryIndex: Int);
  F64Store(offset: Int, align: Int, ?memoryIndex: Int);
  I32Store8(offset: Int, align: Int, ?memoryIndex: Int);
  I32Store16(offset: Int, align: Int, ?memoryIndex: Int);
  I64Store8(offset: Int, align: Int, ?memoryIndex: Int);
  I64Store16(offset: Int, align: Int, ?memoryIndex: Int);
  I64Store32(offset: Int, align: Int, ?memoryIndex: Int);
